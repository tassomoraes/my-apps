...
public class SaoJoseActivity extends AppCompatActivity {
    ...
    public void concluirDia(){
        ...
        switch (dia){
            case 1:
                tituloDia = R.string.sj_titulo_dia1;
                oracaoDia = R.string.sj_oracao_dia1;
                break;
            case 2:
                tituloDia = R.string.sj_titulo_dia2;
                oracaoDia = R.string.sj_oracao_dia2;
                break;
            case 3:
                tituloDia = R.string.sj_titulo_dia3;
                oracaoDia = R.string.sj_oracao_dia3;
                break;
            case 4:
                tituloDia = R.string.sj_titulo_dia4;
                oracaoDia = R.string.sj_oracao_dia4;
                break;
            case 5:
                tituloDia = R.string.sj_titulo_dia5;
                oracaoDia = R.string.sj_oracao_dia5;
                break;
            case 6:
                tituloDia = R.string.sj_titulo_dia6;
                oracaoDia = R.string.sj_oracao_dia6;
                break;
            case 7:
                tituloDia = R.string.sj_titulo_dia7;
                oracaoDia = R.string.sj_oracao_dia7;
                break;
            case 8:
                tituloDia = R.string.sj_titulo_dia8;
                oracaoDia = R.string.sj_oracao_dia8;
                break;
            case 9:
                tituloDia = R.string.sj_titulo_dia9;
                oracaoDia = R.string.sj_oracao_dia9;
                break;
        }
